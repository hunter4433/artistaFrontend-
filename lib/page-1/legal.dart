    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Center(child: Padding(
          ...
          child: Text('''
1. Introduction
[Twizzle] (hereinafter referred to as "we," "our," or "us") operates an online platform through a mobile application that connects users with artists for private, corporate, and public events. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you use our app.
...
Address: [singhani, loharu haryana 127201]
...
Welcome to [twizzle]. By using our app, you agree to these Terms and Conditions. Please read them carefully before using our services. If you do not agree with any part of these terms, you must not use our app.
...
Eligibility: You must be at least 18 years old to use our app. By accessing the app, you confirm that you are of legal age to form a binding contract.
...
At [App Name], we value customer satisfaction and aim to ensure a seamless experience for both users and artists. Our refund policy outlines the terms and conditions for canceling a booking and requesting a refund. Please read this policy carefully before making any bookings on our platform.
...
Phone: [Your Contact Number]''',style: TextStyle(fontSize: 17),)),
        ),
      ),
    );
  }
